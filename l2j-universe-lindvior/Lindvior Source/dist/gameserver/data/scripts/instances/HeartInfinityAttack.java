...
public class HeartInfinityAttack extends Reflection {
    ...
    private void handleEkimusStats() {
        ...
        ekimus.addStatFunc(new FuncSet(Stats.PHYSICAL_ATTACK, 0x30, this, ekimus.getTemplate().getBasePAtk() * 3)); // constant
        ekimus.addStatFunc(new FuncSet(Stats.MAGIC_ATTACK, 0x30, this, ekimus.getTemplate().getBaseMAtk() * 10)); // constant
        ekimus.addStatFunc(new FuncSet(Stats.PHYSICAL_DEFENCE, 0x30, this, ekimus.getTemplate().getBasePDef() * a[1]));
    ...
    private void conquestConclusion(boolean win) {
        ...
        for (Player p : getPlayers()) {
            ...
            p.sendPacket(new ExShowScreenMessage(win ? NpcString.CONGRATULATIONS_YOU_HAVE_SUCCEEDED_AT_S1_S2_THE_INSTANCE_WILL_SHORTLY_EXPIRE : NpcString.YOU_HAVE_FAILED_AT_S1_S2, 8000, ExShowScreenMessage.ScreenMessageAlign.MIDDLE_CENTER, false, 1, -1, false, "#"
