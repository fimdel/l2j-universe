...
public class IsthinaNormal extends Reflection {
    ...
    private final CurrentHpListener _currentHpListenerBallista = new CurrentHpListener();
                ...
                ThreadPoolManager.getInstance().schedule(new Runnable() {
                    ...
                    public void run() {
                        ...
                        for (Player player : getPlayers()) {
                            ...
                            player.sendPacket(new ExSendUIEvent(player, 0, 0, progress, 122520, NpcString.NONE2));
    ...
    private class SpawnBallista extends RunnableImpl {
        ...
        public void runImpl() throws Exception {
            ...
            for (Player players : getPlayers()) {
                players.sendPacket(new ExShowScreenMessage(NpcString.AFTER_$s1_SECONDS_THE_CHARGING_MAGIC_BALLISTAS_STARTS, 5000, ExShowScreenMessage.ScreenMessageAlign.TOP_CENTER, false, String.valueOf(1)));
            }
