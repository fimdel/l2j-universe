...
public class FortunaInstance extends Reflection {
    ...
    private class EndTwoStageMob extends RunnableImpl {
        ...
        @Override
        public void runImpl() {
            NpcInstance voitelSpecial = addSpawnWithoutRespawn(52001, new Location(42104, -176344, -7974, 15956), 0);
    ...
    private class EndOneStageMob extends RunnableImpl {
        ...
        @Override
        public void runImpl() {
            NpcInstance yarostSpecial = addSpawnWithoutRespawn(52000, new Location(42104, -176344, -7974, 15956), 0);
