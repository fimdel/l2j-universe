...
public class _460_PreciousResearchMaterial extends Quest implements ScriptFile {
    ...
    private static final int ITEM_TEREDOR_EGG_FRAGMENT = 17735;    // ЧастьЯйцаТраджана
    private static final int[] MOB_EGGS = {18997, 19023};
    private static final int REWARD_PROOF_OF_FIDELITY = 19450;    // ДоказательствоВерности
