...
public class _1202_CrystalCaverns extends Quest implements ScriptFile {
    ...
    private static final int[] MOBLIST = new int[]
            {
                    KechisCaptain1, KechisCaptain2, KechisCaptain3, BurningIris, FlameIris, BrimstoneIris, Spinel, ReefGolem, PlazaCaiman, ChromaticDetainee1, CrystallineUnicorn, EmeraldBoar, PlazaHelm
            };
    ...
    public String onFirstTalk(NpcInstance npc, Player player) {
        ...
        if (spawn_captain && Rnd.chance(50)) {
            ...
            captain.addStatFunc(new FuncMul(Stats.PHYSICAL_ATTACK, 0x30, this, 5));
            captain.addStatFunc(new FuncMul(Stats.MAGIC_ATTACK, 0x30, this, 5));
            captain.addStatFunc(new FuncMul(Stats.PHYSICAL_DEFENCE, 0x30, this, 5));
