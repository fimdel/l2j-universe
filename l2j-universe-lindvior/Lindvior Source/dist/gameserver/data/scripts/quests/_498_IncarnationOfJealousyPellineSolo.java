...
public class _498_IncarnationOfJealousyPellineSolo extends Quest implements ScriptFile {
    ...
    private static final int MOB_PELLINI = 25883;
    private static final int REWARD_DIMENSION_TRAVELERS_RED_BOX = 34931;

    public _498_IncarnationOfJealousyPellineSolo() {
        super(PARTY_NONE);

        addStartNpc(NPC_KARTIA_RESEARCHER);
        addKillNpcWithLog(1, "PelliniSolo", 1, MOB_PELLINI);
        addLevelCheck(90, 94);
    }
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("33647-07.htm")) {
            ...
            st.unset("cond");
            st.giveItems(REWARD_DIMENSION_TRAVELERS_RED_BOX, 1);
