...
public class _495_IncarnationOfJealousyPellineGroup extends Quest implements ScriptFile {
    ...
    private static final int MOB_PELLINE = 25882;
    private static final int REWARD_DIMENSION_KEEPERS_RED_BOX = 34927;

    public _495_IncarnationOfJealousyPellineGroup() {
        super(PARTY_ALL);

        addStartNpc(NPC_KARTIA_RESEARCHER);
        addKillNpcWithLog(1, "PellineGroup", 1, MOB_PELLINE);
        addLevelCheck(90, 94);
    }
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("33647-04.htm")) {
            ...
            st.unset("cond");
            st.giveItems(REWARD_DIMENSION_KEEPERS_RED_BOX, 1);
    ...
    public boolean isVisible(Player player) {
        QuestState qs = player.getQuestState(_495_IncarnationOfJealousyPellineGroup.class);
