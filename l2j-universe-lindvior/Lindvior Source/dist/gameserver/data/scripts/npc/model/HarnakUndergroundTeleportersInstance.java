...
import l2p.gameserver.instancemanager.HarnakUndegroundManager;
 ...
 * Time: 7:30
 */
public class HarnakUndergroundTeleportersInstance extends NpcInstance {
    ...
    public HarnakUndergroundTeleportersInstance(int objectId, NpcTemplate template) {
