...
public enum SystemMsg implements IStaticPacket {
    ...
    // Message: Vitality is applied, and you are receiving 300% bonus XP while hunting. You can use a maximum of 5 Vitality items per week, including Replenishing and Maintaining items.
    ...
    // Message: Player $c1 will be replaced. Replacement will occur within 3 minutes upon approval by the party leader
    PLAYER_C1_WILL_BE_REPLACED(3679),
    // Message: You have accepted to join a party. Replacement will occur within 3 minutes upon approval by the party leader.
    YOU_HAVE_ACCEPTED_TO_JOIN_A_PARTY(3683),
    // Message: The maximum matches you can participate in 1 week is 70.
    THE_MAXIMUM_MATCHES_YOU_CAN_PARTICIPATE_IN_1_WEEK_IS_50(3224),
    // Message: The matches this week are class battles, the number of matches that are allowed to participate is $s1.
    THE_MATCHES_THIS_WEEK_ARE_CLASS_BATTLES_THE_NUMBER_OF_MATCHES_THAT_ARE_ALLOWED_TO_PARTICIPATE_IS_S1(3331),
    // The matches this week are class-free battles, the number of matches that are allowed to participate is $s1.
    THE_MATCHES_THIS_WEEK_ARE_CLASS_FREE_BATTLES_THE_NUMBER_OF_MATCHES_THAT_ARE_ALLOWED_TO_PARTICIPATE_IS_S1(3261),
    THE_NEW_SUBCLASS_S1_HAS_BEEN_ADDED(1269),
    STOPPED_LOOKING_FOR_A_PLAYER_WHO_WILL_REPLACE_S1(3446),
    ...
    public L2GameServerPacket packet() {
        if (_message == null) {
            throw new NoSuchElementException("Running SystemMsg.packet(Player), but message require arguments: " + name());
        }
