...
public abstract class Playable extends Creature {
    ...
    public int getPAtkSpd() {
        return Math.max((int) calcStat(Stats.PHYSICAL_ATTACK_SPEED, calcStat(Stats.ATK_BASE, _template.getBasePAtkSpd(), null, null), null, null), 1);
    }
    ...
    public Playable getPet() {
        // TODO Нужен метод таргета саммона
        return null;
    }
}
