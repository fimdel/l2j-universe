...
public class PetInstance extends Summon {
    ...
    public int getAccuracy() {
        return (int) calcStat(Stats.PHYSICAL_ACCURACY_COMBAT, _data.getAccuracy(), null, null);
    }
    ...
    public int getCriticalHit(Creature target, Skill skill) {
        return (int) calcStat(Stats.PHYSICAL_CRIT_BASE, _data.getCritical(), target, skill);
    }
    ...
    public int getEvasionRate(Creature target) {
        return (int) calcStat(Stats.PHYSICAL_EVASION_RATE, _data.getEvasion(), target, null);
    }
    ...
    public int getPAtk(Creature target) {
        ...
        return (int) calcStat(Stats.PHYSICAL_ATTACK, _data.getPAtk() / mod, target, null);
    }
    ...
    public int getPDef(Creature target) {
        ...
        return (int) calcStat(Stats.PHYSICAL_DEFENCE, _data.getPDef() / mod, target, null);
    }
    ...
    public int getPAtkSpd() {
        return (int) calcStat(Stats.PHYSICAL_ATTACK_SPEED, calcStat(Stats.ATK_BASE, _data.getAtkSpeed(), null, null), null, null);
    }
