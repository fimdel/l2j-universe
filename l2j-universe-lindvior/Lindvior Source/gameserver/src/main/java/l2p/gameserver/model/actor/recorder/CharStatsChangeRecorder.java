...
public class CharStatsChangeRecorder<T extends Creature> {
    ...
    protected int _MageAccuracy;
    protected int _attackSpeed;
    protected int _castSpeed;
    protected int _criticalHit;
    protected int _MageCriticalHit;
    protected int _evasion;
    protected int _MageEvasion;
    ...
    protected void refreshStats() {
        ...
        _MageCriticalHit = set(SEND_CHAR_INFO, _MageCriticalHit, _activeChar.getMagicCriticalRate(null, null));
        _MageEvasion = set(SEND_CHAR_INFO, _MageEvasion, _activeChar.getMEvasionRate(null));
        _MageAccuracy = set(SEND_CHAR_INFO, _MageAccuracy, _activeChar.getMAccuracy());
