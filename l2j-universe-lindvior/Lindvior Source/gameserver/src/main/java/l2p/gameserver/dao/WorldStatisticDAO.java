...
public class WorldStatisticDAO {
    ...
    public void updateStatisticFor(Player player, CategoryType categoryType, int subCat, long value) {
        Connection con = null;
    ...
    public List<CharacterStatisticElement> getPersonalStatisticFor(int charId) {
        ...
        try {
            ...
            while (rset.next()) {
                ...
                statistics.add(new CharacterStatisticElement(categoryType, rset.getInt(2), rset.getLong(3), rset.getLong(4)));
            }
        } catch (Exception e) {
    ...
    public List<CharacterStatistic> getStatisticForCategory(CategoryType cat, boolean global, int limit) {
        ...
        try {
            ...
            while (rset.next()) {
                CharacterStatisticElement statisticElement = new CharacterStatisticElement(cat, rset.getInt(3));
