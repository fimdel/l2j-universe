...
public class SystemMessage extends L2GameServerPacket {
    ...
    public static final int THE_LEVEL_S1_SHILENS_BREATH_WILL_BE_ASSESSED = 1916; // Уровень штрафа за смерть: $s1.
    public static final int THE_SHILENS_BREATH_HAS_BEEN_LIFTED = 1917; // Штраф за смерть отменен.
    ...
    public static final int ONLY_CHARACTERS_OVER_LEVEL_76_WHO_COMPLETED_3RD_CLASS_TRANSFER_MAY_BE_A_SPONSOR_OF_ACADEMY_TRAINEE = 3573;
    ...
    public SystemMessage clone() {
        return new SystemMessage(this._messageId);
    }
}
